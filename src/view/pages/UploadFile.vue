<template>
  <div>
    ...
    <div class="row">
      <div class="col-md-12">
        <KTCodePreview v-bind:title="'Upload File'">
          <template v-slot:preview>
            ...
            <div>
              <b-form @submit="onSubmit" @reset="onReset" v-if="show">
                ...
                <b-form-group id="input-group-2" label="Bulan:" label-for="input-2">
                  <b-form-input id="input-2" v-model="form.name" required placeholder="Enter name">
                  </b-form-input>
                </b-form-group>
                <b-form-group id="input-group-2" label="Judul Kegiatan:" label-for="input-2">
                  <b-form-input id="input-2" v-model="form.name" required placeholder="Enter name">
                  </b-form-input>
                </b-form-group>
                <label class="mr-sm-2" for="inline-form-custom-select-pref">Jenis File:</label>
                <b-form-select id="inline-form-custom-select-pref" class="mb-2 mr-sm-2 mb-sm-0"
                  :options="[{ text: 'Choose...', value: null }, 'Pengajuan', 'LPJ',]" :value="null"></b-form-select>
